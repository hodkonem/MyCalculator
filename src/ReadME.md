...
Данные передаются в одну строку (смотри пример)! Решения, в которых каждое число и арифмитеческая операция передаются с 
...
Сначала надо разработать алгоритм решенимя этой задачи:
1. Получить строку с арифметическим выражением от пользователя.
2.Разбить строку на числа и операторы.
3.Определить тип чисел (арабские и римские).
4. Выполнить операцию, которая использует соответствующий оператор.
5. Вывести в консоль результат.